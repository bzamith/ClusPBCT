...
class DatasetsGenerator:
	...
	def __init__(self, file_name, file_path=os.path.dirname(os.path.abspath(__file__)), h_train = True, h_valid = True, h_test = True, 
...
if __name__ == '__main__':
	...
	teste = DatasetsGenerator(file_name = args.inputFile)
