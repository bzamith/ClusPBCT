...
public abstract class ClusInductionAlgorithmType {
	...
	public abstract ClusInductionAlgorithm createInduce(ClusSchema schema, ClusSchema secondSchema, Settings sett, CMDLineArgs cargs) throws ClusException, IOException;
        // ********************************
	...
	public ClusStatManager getSecondStatManager() {
		return getInduce().getSecondStatManager();
	}
